...
public class HotelFilterTests(DatabaseFixture fixture) : IAsyncLifetime
{
    ...
    public async Task GetFiltered_ByName_ReturnsOnlyMatchingHotels()
    {
        ...
        var (items, _) = await repo.GetFilteredAsync("Test Hotel", null, null, null, null, null, null, null, null, null, null, null, null, null, null, 1, 20);
    ...
    public async Task GetFiltered_ByCity_ReturnsOnlyHotelsInThatCity()
    {
        ...
        var (items, _) = await repo.GetFilteredAsync(null, null, "TestCity", null, null, null, null, null, null, null, null, null, null, null, null, 1, 20);
    ...
    public async Task GetFiltered_ExcludesArchivedHotels()
    {
        ...
        var repo = new HotelRepository(_ctx);
        var (items, _) = await repo.GetFilteredAsync(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 1, 100);
    ...
    public async Task GetFiltered_NonExistentCity_ReturnsEmpty()
    {
        ...
        var (items, total) = await repo.GetFilteredAsync(null, null, "CityThatDoesNotExist_xyz", null, null, null, null, null, null, null, null, null, null, null, null, 1, 20);
    ...
    public async Task GetFiltered_ByPriceRange_IncludesHotelWithMatchingVariant()
    {
        ...
        var (items, _) = await repo.GetFilteredAsync(null, null, null, null, 90m, 110m, null, null, null, null, null, null, null, null, null, 1, 1000);
    ...
    public async Task GetFiltered_ByPriceRange_ExcludesHotelOutsideRange()
    {
        ...
        var (items, _) = await repo.GetFilteredAsync(null, null, null, null, 500m, 600m, null, null, null, null, null, null, null, null, null, 1, 1000);
    ...
    public async Task GetFiltered_ByStarRating_ReturnsOnlyMatchingHotels()
    {
        ...
        var repo = new HotelRepository(_ctx);
        var (items, _) = await repo.GetFilteredAsync(null, null, null, null, null, null, null, null, null, null, null, null, [5], null, null, 1, 1000);
